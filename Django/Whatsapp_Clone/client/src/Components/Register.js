...
export default function Register() {
    ...
    return (
        <div className='container text-center'>
            ...
            <div className='mt-3'>
                <TextField id="first_name" type="text" label="First Name" variant="outlined" onChange={(e) => {
                    setFormData({...formData, first_name: e.target.value})
                }}/>
            </div>
            <div className='mt-3'>
                <TextField id="last_name" type="text" label="Last Name" variant="outlined" onChange={(e) => {
